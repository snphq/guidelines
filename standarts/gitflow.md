...
Боевая площадка (сервер) — площадка, предназначенная для  использования функционала.

Тестовая площадка (сервер) - площадка, предназначенная для 
тестирования реализованного функционала.
...
2. Ветвь `develop` деплоится только на тестовую площадку, `master` — только на 
боевую.
...
Git-мастера. Git-мастером обычно назначается лид разработчика на проекту.
...
### 5.4. Необходимо разработать дополнительный функционал к проекту
  ...
  **Важно!**
  ...
  отступов. Также старайтесь не оставляь закомментированный код, который 
...
### 5.6. Дополнительный функционал готов к деплою
  ...
  протестированны, ветка `feature/.*` готова к слиянию в `develop`.
